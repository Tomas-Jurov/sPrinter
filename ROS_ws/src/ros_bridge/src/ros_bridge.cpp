...
void ROSBridge::leftSpeedTargetCallback(const std_msgs::Int8::ConstPtr& msg)
{
}

void ROSBridge::rightSpeedTargetCallback(const std_msgs::Int8::ConstPtr& msg)
{
}

void ROSBridge::tiltSpeedTargetback(const std_msgs::Int8::ConstPtr& msg)
{
}
