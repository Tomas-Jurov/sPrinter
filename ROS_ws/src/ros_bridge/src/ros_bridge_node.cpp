...
int main(int argc, char** argv)
{
    ...
    ros::Subscriber left_speed_target_sub = nh.subscribe("wheels/cmd/left_speed", 1, 
                                                        &ROSBridge::leftSpeedTargetCallback, &ros_bridge);
    ros::Subscriber right_speed_target_sub = nh.subscribe("wheels/cmd/right_speed", 1,
                                                        &ROSBridge::rightSpeedTargetCallback, &ros_bridge);
    ros::Subscriber tilt_speed_target_sub = nh.subscribe("tilt/target_speed", 1,
                                                        &ROSBridge::tiltSpeedTargetback, &ros_bridge);
    ros::Subscriber stepper1_speed_sub = nh.subscribe("stepper1/speed", 1, 
                                                        &ROSBridge::stepper1SpeedCallback, &ros_bridge);
    ros::Subscriber stepper2_speed_sub = nh.subscribe("stepper2/speed", 1, 
                                                        &ROSBridge::stepper2SpeedCallback, &ros_bridge);
    ros::Subscriber stepper1_target_sub = nh.subscribe("stepper1/target_steps", 1, 
                                                        &ROSBridge::stepper1TargetCallback, &ros_bridge);
    ros::Subscriber stepper2_target_sub = nh.subscribe("stepper2/target_steps", 1, 
                                                        &ROSBridge::stepper2TargetCallback, &ros_bridge);
    ros::Subscriber servo1_target_sub = nh.subscribe("servo1/target_angle", 1, 
                                                        &ROSBridge::servo1TargetCallback, &ros_bridge);
    ros::Subscriber servo2_target_sub = nh.subscribe("servo2/target_angle", 1, 
                                                        &ROSBridge::servo2TargetCallback, &ros_bridge);
    ros::Subscriber suntracker_cmd_sub = nh.subscribe("suntracker/do", 1, 
                                                        &ROSBridge::suntrackerCmdCallback, &ros_bridge);
