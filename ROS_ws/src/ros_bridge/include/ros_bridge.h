...
public:
  ...
  // Callbacks
  void leftSpeedTargetCallback(const std_msgs::Int8::ConstPtr& msg);
  void rightSpeedTargetCallback(const std_msgs::Int8::ConstPtr& msg);
  void tiltSpeedTargetback(const std_msgs::Int8::ConstPtr& msg);
