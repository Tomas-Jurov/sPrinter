...
SprinterControl::SprinterControl(const ros::Publisher& safety_stop_pub, const ros::Publisher& heartbeat_pub,
...
void SprinterControl::taskManagerStatusCallback(const diagnostic_msgs::DiagnosticStatus::ConstPtr& msg)
{
  ...
  switch (msg->level)
  {
    case diagnostic_msgs::DiagnosticStatus::OK:
      log_level = ros::console::levels::Info;
      break;
    case diagnostic_msgs::DiagnosticStatus::WARN:
      log_level = ros::console::levels::Warn;
      break;
    case diagnostic_msgs::DiagnosticStatus::ERROR:
      log_level = ros::console::levels::Error;
      break;
    default:
      log_level = ros::console::levels::Debug;
      break;
  }
